...
echo "<p>Ladda upp bild:</p><input type='file' name='bild'>";
...
//    $tmp_filnamn = filter_input(INPUT_POST, 'prod_namn', FILTER_SANITIZE_SPECIAL_CHARS);
    ...
    $stmt->bindParam(":bild", $tmp_filnamn);
